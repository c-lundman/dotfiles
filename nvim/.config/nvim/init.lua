...
-- -- CL: Binding ö to <Esc>
-- vim.keymap.set("n", "ö", "<Esc>") -- Remap in Normal mode
-- vim.keymap.set("i", "ö", "<Esc>") -- Remap in Insert and Replace mode
-- vim.keymap.set("v", "ö", "<Esc>") -- Remap in Visual and Select mode
-- vim.keymap.set("x", "ö", "<Esc>") -- Remap in Visual mode
-- vim.keymap.set("s", "ö", "<Esc>") -- Remap in Select mode
-- vim.keymap.set("c", "ö", "<C-c>") -- Remap in Command-line mode
-- vim.keymap.set("o", "ö", "<Esc>") -- Remap in Operator-pending mode
-- vim.keymap.set("i", "<C-ö>", "ö") -- Remap in Insert and Replace mode
-- vim.keymap.set("c", "<C-ö>", "ö") -- Remap in Command-line mode

-- CL: Centering screen after jumping up and down
vim.keymap.set("n", "<C-d>", "<C-d>zz", { noremap = true, silent = true })
vim.keymap.set("n", "<C-u>", "<C-u>zz", { noremap = true, silent = true })

-- -- CL: Saving file
-- vim.keymap.set({ "n", "i" }, "<leader>w", "<Esc>:w<CR>")
-- vim.keymap.set({ "n", "i" }, "<leader>e", "<C-6>")
--
...

  {
    ...
    config = function()
      ...
      pyrola.setup({
        ...
        image = {
          cell_width = 40,        -- approximate terminal cell width in pixels
          cell_height = 80,       -- approximate terminal cell height in pixels
